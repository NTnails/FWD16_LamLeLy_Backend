...
$result = $pdo->query("call sp_movies");
...
<!-- Länk till lägga till nya film -->        
       <a href="movieAdd.php">Add New Film</a> | <a href="category.php">Category</a><br/><br/>
...
*/    
    while($row = $result->fetch()) {         
        ...
        echo "<td><a href=\"movieEdit.php?movieId=$row[movieId]\">Edit</a> | <a href=\"movieDelete.php?movieId=$row[movieId]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
    } 
