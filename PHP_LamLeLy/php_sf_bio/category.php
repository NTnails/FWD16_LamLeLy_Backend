...
$result = $pdo->query("call sp_categories");
...
<!-- Länk till lägga till nya film -->        
       <a href="categoryAdd.php">Add Category</a> | <a href="movie.php">Home</a> <br/><br/>
...
*/    
    while($row = $result->fetch()) {         
        ...
        echo "<td><a href=\"categoryEdit.php?categoryId=$row[categoryId]\">Edit</a> | <a href=\"categoryDelete.php?categoryId=$row[categoryId]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
    } 
