 ...
 */
 ...
 $insert = $pdo->prepare("INSERT INTO directors (name,state,gender,email,pass)
values(:name, :state, :gender, :email,:pass) ");
 ...
 */
 ...
 $select = $pdo->prepare("SELECT * FROM directors WHERE email='$email' and pass='$pass'");
 $select->setFetchMode();
 $select->execute();
 $data=$select->fetch();
 /*
